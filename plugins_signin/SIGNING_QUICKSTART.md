...
```text
python plugins_signin/sign_via_service.py plugins/my_plugin.py --service-url https://verycomplexandlongname.pythonanywhere.com --username <login> --password <password> --signer-id promptman-team --trusted-signer-json /path/to/promptman-team.trusted-signer.json
```
